...
<body>
    ...
    <div>
        <img class="img-1" src="../img/fondo2.png" alt="Tarjeta Grafica">
    </div>
    <main>
        <section class="categoria_h">
            <h2 class="letra_filtrar">Filtrar por subcategorias</h2>
            <h1>Hadware</h1>
            <div class="hardware_tipos_h">
                <ul>
                    <li>Procesadores</li>
                    <li>Mainboards</li>
                    <li>Memorias RAM</li>
            ...
            <div class="contenedor-principal_h">
                <div class="contenedor-productos_h">
                    <div class="producto_1_h">
                        ...
                        <div class="descripcion_producto_h">
                            <p class="codigo_h">SKU:PC42788</p><br>
                            <p class="nombre_h">PC GAMER</p><br>
                            <p class="precio_h">$ 904.32</p>

                            <input class="cantidad_h" type="number">
                            
                            <button class="compras_h" href=""><svg width="25" height="22" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="Group 39">
